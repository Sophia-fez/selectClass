...
<head>
	<meta charset="UTF-8">
	<title>学生首页</title>
    <link rel="stylesheet" href="../../public/css/student_index.css" />
</head>

<body class="all">

    <div class="A">
        <div class="link"><a href="<?php echo U('Student/chooseCourse');?>">进入学生选课系统</a></div>
        <div class="link"><a href="<?php echo U('Student/courseList');?>">学生已选课程管理</a></div>
    ...
    <form method="post" action="<?php echo U('/Student/stuedit_do');?>">
        <div class="submit">
